...
*       Prints an error message is the user enters an       *
*       illegal code.                                       *
*************************************************************/
...
*        on hand. Parts are printed in the order of part    *
*        number.                                            *
*************************************************************/

void print(void)
{
	int i, j, parts_printed = 0;
	
	printf("Part Number        Part Name        Quantity on Hand\n");
	for (i = 0;; i++)
	{
		if (parts_printed == num_parts)
		{
			return;
		}
		for (j = 0; j < num_parts; j++)
		{
			if (i == inventory[j].number)
			{
