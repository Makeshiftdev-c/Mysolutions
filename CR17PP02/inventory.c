...
*        on hand. Parts are printed in order of part number.*
*************************************************************/
...
/************************************************************
* compare_parts: Comparison function for qsort function.    *
*                Returns -1 if first argument is less than  *
*                second argument; returns 0 if first        *
*                argument is equal to second argument;      *
*                otherwise, returns 1.                      *
*************************************************************/
